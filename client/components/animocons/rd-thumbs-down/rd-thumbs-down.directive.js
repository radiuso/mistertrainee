...
angular.module('mtApp')
  .directive('rdThumbsDown', function (animocons) {
    return {
      templateUrl: 'components/animocons/rd-thumbs-down/rd-thumbs-down.html',
      restrict: 'EA',
      scope: {
        onCheck:'&',
        onUncheck: '&',
      ...
      link: function (scope, element, attrs) {
        ...
        element.addClass('icobutton icobutton--thumbs-down');
